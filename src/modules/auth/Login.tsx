        ...
        <section className="bg-white dark:bg-gray-900" >
            ...
            <div className="container px-6 py-24 mx-auto lg:py-32" >
                <div className="lg:flex" >
                    <div className="lg:w-1/2 relative rounded-3xl overflow-hidden shadow-2xl flex flex-col justify-center p-8 lg:p-14" >
                        <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 hover:scale-105" style={{ backgroundImage: 'url("/login.png")' }} />
                        <div className="absolute inset-0 bg-gradient-to-t from-gray-900/90 via-gray-900/60 to-gray-900/40 backdrop-blur-[2px]" />
                        
                        <div className="relative z-10">
                            <div className="flex items-center gap-3" >
                                <div className="p-2 bg-cyan-500/20 rounded-xl backdrop-blur-md border border-cyan-400/30">
                                    <Network className="text-cyan-400" size={32} />
                                </div>
                                <span className="font-bold text-4xl text-white tracking-wide">AIOps Core</span>
                            </div>

                            <h1 className="mt-10 text-3xl font-bold text-white capitalize lg:text-4xl leading-tight" >
                                Login to your account
                            </h1>
                            <p className="mt-4 text-gray-200 text-lg max-w-md font-light">
                                Access your observability dashboards, monitor system health, and respond to incidents in real-time.
                            </p>

                            <div className="mt-12 md:mt-24" >
                                <div className="flex items-center gap-4" >
                                    <a className="text-gray-300 transition-all duration-300 hover:text-cyan-400 hover:scale-110" href="#" >
                    ...
                    <div className='flex flex-col mt-8 lg:w-1/2 lg:mt-0 lg:pl-12'>
                        <div className="mt-8" >
